...
@section('content')
    ...
    @else
        ...
        <div class="row">
            ...
            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens1.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('injecao')">
            ...
            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/screens2.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('pintura')">
                <div class="screen-content">
                    Pintura
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens3.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('montagem')">
                <div class="screen-content">
                    Montagem
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens4.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('qualidade')">
                <div class="screen-content">
                    Qualidade
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens5.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('manutencao')">
                <div class="screen-content">
                    Manutenção
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens6.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('engenharia')">
                <div class="screen-content">
                    Engenharia
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens7.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('higiene')">
                <div class="screen-content">
                    Higiene e Segurança
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens8.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('lean')">
                <div class="screen-content">
                    Lean
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens9.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('qcdd')">
                <div class="screen-content">
                    QCDD
                </div>
            </div>

            <div class="screen touch-screen screen-overlay" style="background-image: url('{{ asset('img/screens/Screens10.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('rh')">
                <div class="screen-content">
                    Recursos Humanos
                </div>
            </div>

            <div class="screen touch-screen screen-overlay disabled" style="background-image: url('{{ asset('img/screens/screens11.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('empty')">
                <div class="screen-content">
                    Empty
                </div>
            </div>

            <div class="screen touch-screen screen-overlay disabled" style="background-image: url('{{ asset('img/screens/Screens12.jpg') }}'); background-size: cover; background-position: center;" onclick="showContent('empty2')">
                <div class="screen-content">
                    Empty2
                </div>
            </div>
